...
class EasyCarousel {
  ...
  createCarouselItem(child) {
    let isClone = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  ...
  createDots() {
    ...
    const dotsCount = this.settings.loop && this.originalItemsCount > this.settings.items ? this.originalItemsCount - this.settings.items + 1 : this.items.length - this.settings.items + 1;
    this.dots = [];
